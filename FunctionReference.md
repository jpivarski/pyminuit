...
Runs Minuit's famous MIGRAD algorithm, an optimized gradient-based minimum search.  This function's behavior is affected by the following Minuit data members.  (You can set parameters like this:
```
>>> m.up = 0.5
```
